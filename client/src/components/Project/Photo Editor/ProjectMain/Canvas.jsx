...
export const Canvas = ({ projectId, projectInfo }) => {
    ...
    return (
        ...
        <>
            ...
            <Button onClick={() => loadJson(canvas)}>load Json</Button>
        ...
        <div id="drawing-mode-options">
          ...
          <input type="color" id="drawing-color" value={drawingColor} onChange={(e) => changeColor(e.target.value)}/>
          <br />
          <label htmlFor="drawing-shadow-color">Shadow Color:</label>
          <input type="color" id="drawing-shadow-color" value={shadowColor} onChange={(e) => changeShadowColor(e.target.value)}/>
          <br />
